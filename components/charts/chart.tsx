...
export default function Chart({ children, className }: { children?: any, className?: string }) {
    return (
        <motion.div
            className={twMerge('group w-full p-4 my-4 relative z-1  bg-white-900 border border-white-600 overflow-hidden rounded-[20px] shadow-md shadow-white-300', className)}
