 ...
 */                        <Card
                        ...
                        <CardHeader className=" relative z-20 text-white-100 font-sans  h-full flex justify-center space-y-4 text-center">
                            <CardTitle className="text-white-00 tracking-wide text-3xl font-moglan opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                                style={{
