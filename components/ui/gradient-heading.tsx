...
const headingVariants = cva(
    "tracking-tight pb-3 bg-clip-text text-transparent",
    {
        variants: {
            variant: {
                default:
                    "bg-gradient-to-t from-white-700 to-white-800 dark:from-stone-200 dark:to-white-200",
                pink: "bg-gradient-to-t from-accent to-accent/90 dark:from-stone-200 dark:to-white-200",
                light: "bg-gradient-to-t from-white-200 to-white-300",
                secondary:
