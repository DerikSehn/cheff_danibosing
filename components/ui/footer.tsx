...
export function Footer() {
    ...
    return (
        <footer className="relative w-full py-20 min-h-[600px] h-[50dvh] bg-primary-200">
            <div className="mx-auto w-full max-w-screen-2xl px-8 text-white-400">
                    ...
                    <div className="flex flex-col gap-2">
                        {LINKS.map(({ title, items }) => (
                            <ul key={title}>
                                ...
                                {items.map(({ href, name }) => (
                                    <li key={href}>
                                        <Link href={href} className="py-1.5 font-normal transition-colors hover:text-white-200">
                                            {name}
                                        </Link>
                                    </li>
                                ))}
                ...
                <div className="mt-12 flex w-full flex-col items-center justify-between border-t border-white-50 py-4 md:flex-row">
