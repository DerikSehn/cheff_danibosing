...
export const ServiceCard = ({ item, className }: { item: ModelWithImage<Service>, className?: string }) => {
    ...
    return (
        <motion.div
            ...
            className={cn("grid md:grid-cols-2 justify-center relative overflow-hidden rounded-lg bg-white-200/50 hover:bg-white-50 transition-colors  dark:bg-gray-800",
                className
            )}
        >
            <div className="p-6">
