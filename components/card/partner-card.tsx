...
export const PartnerCard = ({ item, className }: { item: ModelWithImage<Partner>, className?: string }) => {
    ...
    return (
        <motion.div
            ...
            className={cn("flex flex-col space-y-2 justify-center relative overflow-hidden rounded-lg bg-white-200/50 hover:bg-white-50 transition-colors  dark:bg-gray-800",
                className
            )}
        >
