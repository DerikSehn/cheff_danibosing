...
const TableItemEditor = ({ item, onClose = () => { }, tableName, method }: TableItemEditorProps) => {
    ...
    return (
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} id="step-item-editor" className="md:p-4 pb-20 border-l shadow-inner max-h-[calc(100dvh-140px)] h-[calc(100dvh-140px)] overflow-y-auto border-white-200 w-full  ">
            <AutoForm
